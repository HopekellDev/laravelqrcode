...
use HopekellDev\QrCode\DataTypes\DataTypeInterface;
...
class Generator
{
     ...
     * @param HopekellDev\QrCode\boolean|bool $absolute
     * @return Generator
     */
    ...
    protected function formatClass(string $method): string
    {
        ...
        $class = "HopekellDev\QrCode\DataTypes\\".$method;
